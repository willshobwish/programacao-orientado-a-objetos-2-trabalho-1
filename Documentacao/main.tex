...
%Comando para título
% Comparação da eficiencia das analises de imagens com redes neurais convolucionais Keras e Tensorflow 
\newcommand{\titulo}{\uppercase{Primeiro trabalho bimestral de programação orientado a objetos II}}
% Nome
\newcommand{\nome}{\uppercase{Bruno Augusto Furquim\\Giovanna Santos Custodio\\Willian Yoshio Murayama}}
% Orientador
\newcommand{\orientador}{Prof. Me. Bruno Santos de Lima}
% Cidade e Estado
\newcommand{\cidade}{Presidente Prudente -- São Paulo}
